...
import static com.jrummyapps.picasso.RequestHandler.calculateInSampleSize;
import static com.jrummyapps.picasso.RequestHandler.createBitmapOptions;
import static com.jrummyapps.picasso.RequestHandler.requiresInSampleSize;
...
public class RequestHandlerTest {
  ...
  @Test public void inPurgeableIfInPurgeable() {
    final Request request = new Request.Builder(TestUtils.URI_1).purgeable().build();
