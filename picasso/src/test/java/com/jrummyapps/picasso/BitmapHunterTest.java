...
import static com.jrummyapps.picasso.BitmapHunter.forRequest;
import static com.jrummyapps.picasso.BitmapHunter.transformResult;
import static com.jrummyapps.picasso.Picasso.LoadedFrom.MEMORY;
import static com.jrummyapps.picasso.Picasso.Priority.HIGH;
import static com.jrummyapps.picasso.Picasso.Priority.LOW;
import static com.jrummyapps.picasso.Picasso.Priority.NORMAL;
...
public class BitmapHunterTest {
  ...
  @Test public void forFileWithAuthorityRequest() {
    ...
    BitmapHunter hunter = forRequest(TestUtils.mockPicasso(new FileRequestHandler(RuntimeEnvironment.application)), dispatcher,
        cache, stats, action);
 ...
 @Test public void exifRotationSizing() throws Exception {
    Request data = new Request.Builder(TestUtils.URI_1).resize(5, 10).build();
    Bitmap source = Bitmap.createBitmap(10, 10, ARGB_8888);
    Bitmap result = transformResult(data, source, ORIENTATION_ROTATE_90);
    ShadowBitmap shadowBitmap = shadowOf(result);
    assertThat(shadowBitmap.getCreatedFromBitmap()).isSameAs(source);
 ...
 @Test public void rotation90Sizing() throws Exception {
    Request data = new Request.Builder(TestUtils.URI_1).rotate(90).resize(5, 10).build();
    Bitmap source = Bitmap.createBitmap(10, 10, ARGB_8888);
 ...
 @Test public void rotation180Sizing() throws Exception {
    Request data = new Request.Builder(TestUtils.URI_1).rotate(180).resize(5, 10).build();
    Bitmap source = Bitmap.createBitmap(10, 10, ARGB_8888);
    Bitmap result = transformResult(data, source, 0);
    ShadowBitmap shadowBitmap = shadowOf(result);
    assertThat(shadowBitmap.getCreatedFromBitmap()).isSameAs(source);
 ...
 @Test public void rotation90WithPivotSizing() throws Exception {
    Request data = new Request.Builder(TestUtils.URI_1).rotate(90,0,10).resize(5, 10).build();
    Bitmap source = Bitmap.createBitmap(10, 10, ARGB_8888);
    Bitmap result = transformResult(data, source, 0);
    ShadowBitmap shadowBitmap = shadowOf(result);
    assertThat(shadowBitmap.getCreatedFromBitmap()).isSameAs(source);
  ...
  @Test public void centerCropResultMatchesTargetSizeWhileDesiredWidthIs0() {
    Request request = new Request.Builder(TestUtils.URI_1).resize(0, 642).centerCrop().build();
    Bitmap source = Bitmap.createBitmap(640, 640, ARGB_8888);
  ...
  @Test public void centerCropResultMatchesTargetSizeWhileDesiredHeightIs0() {
    Request request = new Request.Builder(TestUtils.URI_1).resize(1080, 0).centerCrop().build();
    Bitmap source = Bitmap.createBitmap(640, 640, ARGB_8888);
  ...
  @Test public void centerInsideResultMatchesTargetSizeWhileDesiredWidthIs0() {
    Request request = new Request.Builder(TestUtils.URI_1).resize(0, 642).centerInside().build();
    Bitmap source = Bitmap.createBitmap(640, 640, ARGB_8888);
  ...
  @Test public void centerInsideResultMatchesTargetSizeWhileDesiredHeightIs0() {
    Request request = new Request.Builder(TestUtils.URI_1).resize(1080, 0).centerInside().build();
    Bitmap source = Bitmap.createBitmap(640, 640, ARGB_8888);
  ...
  @Test public void centerCropWithGravityHorizontalLeft() {
    Bitmap source = Bitmap.createBitmap(20, 10, ARGB_8888);
    Request data = new Request.Builder(TestUtils.URI_1).resize(40, 40).centerCrop(Gravity.LEFT).build();
  ...
  @Test public void centerCropWithGravityHorizontalRight() {
    Bitmap source = Bitmap.createBitmap(20, 10, ARGB_8888);
    Request data = new Request.Builder(TestUtils.URI_1).resize(40, 40).centerCrop(Gravity.RIGHT).build();
  ...
  @Test public void centerCropWithGravityVerticalTop() {
    Bitmap source = Bitmap.createBitmap(10, 20, ARGB_8888);
    Request data = new Request.Builder(TestUtils.URI_1).resize(40, 40).centerCrop(Gravity.TOP).build();
  ...
  @Test public void centerCropWithGravityVerticalBottom() {
    Bitmap source = Bitmap.createBitmap(10, 20, ARGB_8888);
    Request data = new Request.Builder(TestUtils.URI_1).resize(40, 40).centerCrop(Gravity.BOTTOM).build();
  ...
  @Test public void onlyScaleDownOriginalSmallerWidthIs0() {
    Bitmap source = Bitmap.createBitmap(50, 50, ARGB_8888);
    Request data = new Request.Builder(TestUtils.URI_1).resize(0, 60).onlyScaleDown().build();
    Bitmap result = transformResult(data, source, 0);
    assertThat(result).isSameAs(source);
  ...
  @Test public void onlyScaleDownOriginalSmallerHeightIs0() {
    Bitmap source = Bitmap.createBitmap(50, 50, ARGB_8888);
    Request data = new Request.Builder(TestUtils.URI_1).resize(60, 0).onlyScaleDown().build();
    Bitmap result = transformResult(data, source, 0);
    assertThat(result).isSameAs(source);
  ...
  @Test public void onlyScaleDownOriginalBiggerWidthIs0() {
    Bitmap source = Bitmap.createBitmap(50, 50, ARGB_8888);
    Request data = new Request.Builder(TestUtils.URI_1).resize(0, 40).onlyScaleDown().build();
    Bitmap result = transformResult(data, source, 0);
  ...
  @Test public void onlyScaleDownOriginalBiggerHeightIs0() {
    Bitmap source = Bitmap.createBitmap(50, 50, ARGB_8888);
    Request data = new Request.Builder(TestUtils.URI_1).resize(40, 0).onlyScaleDown().build();
    Bitmap result = transformResult(data, source, 0);
