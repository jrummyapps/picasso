...
import static com.jrummyapps.picasso.Picasso.LoadedFrom.NETWORK;
...
@RunWith(RobolectricGradleTestRunner.class) public class RemoteViewsActionTest {
  ...
  @Test public void clearsCallbackOnCancel() throws Exception {
    ...
    ImageViewAction request =
        new ImageViewAction(picasso, target, null, 0, 0, 0, null, TestUtils.URI_KEY_1, null, callback, false);
    request.cancel();
