...
import static com.jrummyapps.picasso.Utils.createKey;
import static com.jrummyapps.picasso.Utils.isWebPFile;
...
public class UtilsTest {
  ...
  @Test public void matchingRequestsHaveSameKey() throws Exception {
    Request request = new Request.Builder(TestUtils.URI_1).build();
    ...
    Request requestTransform1 = new Request.Builder(TestUtils.URI_1).transform(t1).build();
    Request requestTransform2 = new Request.Builder(TestUtils.URI_1).transform(t2).build();
    ...
    Request requestTransform3 = new Request.Builder(TestUtils.URI_1).transform(t3).transform(t4).build();
    Request requestTransform4 = new Request.Builder(TestUtils.URI_1).transform(t3).transform(t4).build();
    ...
    Request requestTransform5 = new Request.Builder(TestUtils.URI_1).transform(t5).transform(t6).build();
    Request requestTransform6 = new Request.Builder(TestUtils.URI_1).transform(t6).transform(t5).build();
  ...
  @Test public void ensureBuilderIsCleared() throws Exception {
    Request request1 = new Request.Builder(TestUtils.RESOURCE_ID_URI).build();
    Request request2 = new Request.Builder(TestUtils.URI_1).build();
    createKey(request1);
  ...
  @Test public void getResourceById() throws IOException {
    Request request = new Request.Builder(TestUtils.RESOURCE_ID_URI).build();
    Resources res = Utils.getResources(TestUtils.mockPackageResourceContext(), request);
    int id = Utils.getResourceId(res, request);
    assertThat(id).isEqualTo(TestUtils.RESOURCE_ID_1);
  }

  @Test public void getResourceByTypeAndName() throws IOException {
    Request request = new Request.Builder(TestUtils.RESOURCE_TYPE_URI).build();
    Resources res = Utils.getResources(TestUtils.mockPackageResourceContext(), request);
    int id = Utils.getResourceId(res, request);
    assertThat(id).isEqualTo(TestUtils.RESOURCE_ID_1);
  }
