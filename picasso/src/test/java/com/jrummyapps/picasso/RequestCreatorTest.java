...
import static com.jrummyapps.picasso.RemoteViewsAction.AppWidgetAction;
import static com.jrummyapps.picasso.RemoteViewsAction.NotificationAction;
...
public class RequestCreatorTest {
  ...
  @Test public void fetchWithCache() {
    ...
    new RequestCreator(picasso, TestUtils.URI_1, 0).memoryPolicy(MemoryPolicy.NO_CACHE).fetch();
